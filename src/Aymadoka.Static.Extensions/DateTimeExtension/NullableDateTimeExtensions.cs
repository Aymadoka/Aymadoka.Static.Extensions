...
namespace Aymadoka.Static.DateTimeExtension
{
    public static class NullableDateTimeExtensions
    {
        ...
        /// <returns>
        /// 如果 <paramref name="sourceDateTime"/> 不为 <c>null</c>，则返回其字符串表示形式；否则返回 <c>null</c>
        /// </returns>
        /// <remarks>
        /// - 如果 <paramref name="sourceDateTime"/> 为 <c>null</c>，方法将返回 <c>null</c>。
        ...
        /// 如果 <paramref name="sourceDateTime"/> 为 <c>null</c>，则返回 <c>null</c>
        /// </returns>
        /// <remarks>
