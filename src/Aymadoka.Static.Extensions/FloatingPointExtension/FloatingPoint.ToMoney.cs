...
namespace Aymadoka.Static.FloatingPointExtension
{
    public static partial class NumberExtensions
    {
        ...
        public static T ToEven<T>(this T source, int keepPlaceCount = 2) where T : struct, IFloatingPoint<T>
        {
            return T.Round(source, keepPlaceCount, MidpointRounding.ToEven);
        }
    }
}
