...
namespace Aymadoka.Static.DateTimeOffsetExtension
{
    public static class NullableDateTimeOffsetExtensions
    {
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? PreviousDay([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
            ...
            var result = @this.Value.PreviousDay();
            return result;
        }
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? NextDay([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? GetFirstDayOfLastMonth([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
            ...
            var result = @this.Value.GetFirstDayOfLastMonth();
            return result;
        }
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? GetFirstDayOfNextMonth([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? GetFirstDayOfMonth([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? GetLastDayOfMonth([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
        ...
        /// 否则返回 <c>null</c>。
        /// </returns>
        public static DateTime? GetSecondDayToLastOfMonth([NotNullIfNotNull(nameof(@this))] this DateTime? @this)
        {
            if (@this == null)
            {
                return null;
