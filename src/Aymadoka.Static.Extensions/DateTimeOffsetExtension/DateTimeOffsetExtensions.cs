...
namespace Aymadoka.Static.DateTimeOffsetExtension
{
    public static class DateTimeOffsetExtensions
    {
        ...
        /// </remarks>
        public static DateTimeOffset PreviousDay(this DateTimeOffset @this)
        {
        ...
        /// - 返回的 <see cref="DateTimeOffset"/> 保留原始的时区偏移量。
        /// </remarks>
        public static DateTimeOffset NextDay(this DateTimeOffset @this)
        {
            var result = @this.AddDays(1);
            return result;
        }
        ...
        /// </summary>
        /// <param name="this">要获取所在月份最后一天的 <see cref="DateTimeOffset"/>。</param>
